...
<head>
    <title>Register | Bomboskuy</title>
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="text" name="namaUser" id="namaUser" class="form-control" value="{{ old('namaUser') }}" required>
                                        <span class="form-bar"></span>
                                        <label for="namaUser" class="float-label">Nama</label>
                                    </div>
                                    <div class="form-group form-primary">
